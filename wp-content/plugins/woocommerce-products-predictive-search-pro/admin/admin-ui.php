...
class WC_Predictive_Search_Admin_UI
{
	...
	public $support_url = 'https://a3rev.com/forums/forum/woocommerce-plugins/predictive-search/';
		...
		if ( false !== $version_transient ) {
			...
			if ( false === $timeout ) {
				...
				if ( FALSE !== stristr( $version_transient, '||' )
					...
					&& version_compare( get_option('wc_predictive_search_version') , $version_info[0], '<' ) ) {
