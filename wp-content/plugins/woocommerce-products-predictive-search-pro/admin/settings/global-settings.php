		...
		if ( is_admin() && in_array (basename($_SERVER['PHP_SELF']), array('admin.php') ) && isset( $_GET['page'] ) && $_GET['page'] == 'woo-predictive-search' && ( ! isset( $_GET['tab'] ) || $_GET['tab'] == 'global-settings' ) ) {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
     		...
     		array(
           	...
           	array(
           		'name'		=> __( 'Manual Check For New Plugin Version', 'woocommerce-predictive-search' ),
           		'desc'		=> __( 'This plugin supports auto upgrades via your WordPress auto updates. Updates show within 24 hours of release. This feature allows you to call any new version for immediate upgrades instead of having to wait until they show in your WordPress updates.', 'woocommerce-predictive-search' ),
                'type' 		=> 'heading',
           	),
           	array(
			...
			array(
				'name' 		=> __( 'Predictive Search', 'woocommerce-predictive-search' ),
			...
			array(
				'name' 		=> __( "SEO Focus Keywords", 'woocommerce-predictive-search' ),
				'desc' 		=> __("Supported plugins, WordPress SEO and ALL in ONE SEO Pack.", 'woocommerce-predictive-search' ),
				'id' 		=> 'woocommerce_search_focus_plugin',
				'type' 		=> 'select',
				'default'	=> 'none',
				'options'	=> array(
						'none'						=> __( 'Select SEO plugin', 'woocommerce-predictive-search' ) ,
						'yoast_seo_plugin'			=> __( 'Yoast WordPress SEO', 'woocommerce-predictive-search' ) ,
						'all_in_one_seo_plugin'		=> __( 'All in One SEO', 'woocommerce-predictive-search' ) ,
					),
			),
			...
			array(  
				'name' 		=> __( 'Exclude Product Categories', 'woocommerce-predictive-search' ),
				'id' 		=> 'woocommerce_search_exclude_p_categories',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Product Categories', 'woocommerce-predictive-search' ),
				'css'		=> 'width:600px; min-height:80px;',
				'options'	=> $all_p_categories,
				'default'	=> $product_cats_excluded,
			),
			array(  
				'name' 		=> __( 'Exclude Product Tags', 'woocommerce-predictive-search' ),
				'id' 		=> 'woocommerce_search_exclude_p_tags',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Product Tags', 'woocommerce-predictive-search' ),
				'css'		=> 'width:600px; min-height:80px;',
				'options'	=> $all_p_tags,
			...
			array(  
				'name' 		=> __( 'Track Predictive Search Result with Google Analytics', 'woocommerce-predictive-search' ),
			...
			array(  
				'name' 		=> __( 'Google Analytics UID', 'woocommerce-predictive-search' ),
				'desc' 		=> __('Example:', 'woocommerce-predictive-search' ) . ' UA-3423237-10',
			...
			array(  
				'name' 		=> __( 'Query Parameter', 'woocommerce-predictive-search' ),
				'desc' 		=> __( 'The parameter that is to be entered on the track Site Search config page on your Google Anayitics account. Default: [default_value]', 'woocommerce-predictive-search' ),
