...
class WC_Predictive_Search_Bulk_Quick_Editions
{
	...
	public static function column_heading( $existing_columns ) {
		...
		$our_columns = array();
		$our_columns["predictive_search_focuskw"] = __( 'PS Focus KW', 'woocommerce-predictive-search' );
	...
	public static function admin_bulk_edit( $column_name, $post_type ) {
		...
		<fieldset class="inline-edit-col-right inline-edit-predictive-search">
			<div id="wc-predictive-search-fields-bulk" class="inline-edit-col">
				<h4><?php _e( 'Predictive Search', 'woocommerce-predictive-search' ); ?></h4>
                <div class="">
                    <label class="inline-edit-tags">
                        <span class="title" style="width:100px;"><?php _e( 'Focus Keywords', 'woocommerce-predictive-search' ); ?></span> &nbsp;&nbsp;&nbsp;
                        <span class="">
                            <select class="change_ps_keyword change_to" name="change_ps_keyword">
                            <?php
                                $options = array(
                                    '' 	=> __( '- No Change -', 'woocommerce-predictive-search' ),
                                    '1' => __( 'Change to:', 'woocommerce-predictive-search' ),
                                );
                    ...
                    <label class="wc-predictive-keyword-value">
                        <textarea class="predictive_search_focuskw" name="_predictive_search_focuskw" rows="1" cols="22" autocomplete="off" placeholder="<?php _e( 'Enter Focus keywords', 'woocommerce-predictive-search' ); ?>"></textarea>
                    </label>
                </div>
                <div class="">
                    <label class="inline-edit-tags">
                        <span class="title" style="width:100px;"><?php _e( 'Show / Hide', 'woocommerce-predictive-search' ); ?></span> &nbsp;&nbsp;&nbsp;
                        <span class="">
                            <select class="ps_exclude_item" name="ps_exclude_item">
                            <?php
                                $options = array(
                                    '' 	=> __( '- No Change -', 'woocommerce-predictive-search' ),
                                    '1' => __( 'Hide from Predictive Search results', 'woocommerce-predictive-search' ),
									'2' => __( 'Show in Predictive Search results', 'woocommerce-predictive-search' ),
                                );
                                foreach ($options as $key => $value) {
                                    echo '<option value="' . $key . '">' . $value . '</option>';
                                }
	...
	public static function quick_edit( $column_name, $post_type ) {
		...
		<fieldset class="inline-edit-col-right">
			<div id="wc-predictive-search-fields-quick" class="inline-edit-col">
				...
				<div>
					<label class="">
						<span class="title"><?php _e( 'Focus Keywords', 'woocommerce-predictive-search' ); ?></span>
                        <textarea class="_predictive_search_focuskw" name="_predictive_search_focuskw" rows="1" cols="22" autocomplete="off" placeholder="<?php _e( 'Enter Focus keywords', 'woocommerce-predictive-search' ); ?>"></textarea>
					</label>
				</div>
                <div class="inline-edit-group">
					<label class="alignleft">
                        <input type="checkbox" value="1" name="ps_exclude_item" />
                        <span class="checkbox-title"><?php _e('Hide from Predictive Search results.', 'woocommerce-predictive-search' ); ?></span>
                    </label>
				</div>
