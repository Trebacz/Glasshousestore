...
class WC_Predictive_Search_Meta
{
	public static function create_custombox() {
		...
		add_meta_box( 'wc_predictive_search_metabox', __('Predictive Search Meta', 'woocommerce-predictive-search' ) , array('WC_Predictive_Search_Meta','data_metabox'), array( 'post', 'page', 'product' ), 'normal', 'high' );
	}
	...
	?>
		...
		<div class="a3_ps_focus_keyword_container">
	    	<table class="form-table" cellspacing="0">
	        	<tr valign="top">
					<th scope="rpw" class="titledesc"><label for="_predictive_search_focuskw"><?php _e('Focus Keywords', 'woocommerce-predictive-search' ); ?></label></th>
					<td class="forminp">
						<div class="wide_div">
						...
						<span class="description"><?php echo __( 'Enter keywords by "," separating values. Example: iPhone, ios', 'woocommerce-predictive-search' ); ?></span>
					</td>
				</tr>
	        </table>
        </div>
