...
{	
	...
	public function wpml_register_dynamic_string() {
		...
		$wc_predictive_search_header_template_settings = array_map( array( $wc_predictive_search_admin_interface, 'admin_stripslashes' ), get_option( 'wc_predictive_search_header_template_settings', array() ) );
	...
	public function wpml_register_static_string() {
		if ( function_exists('icl_register_string') ) {
			...
			icl_register_string( $this->plugin_wpml_name, 'All', __( 'All', 'woocommerce-predictive-search' ) );
