...
class a3_License_Manager_Plugin_Installer
{
	...
	?>
    	<div class="error below-h2" style="display:block !important; margin-left:2px;">
    		<p><?php echo sprintf( __( 'You need to activate the <a title="" href="%s" target="_parent">a3 License Manager</a> plugin for get auto upgrade when have new version.' , 'woocommerce-predictive-search' ), $activate_url ); ?></p>
    	</div>
    <?php
			}
		} else {
	...
	?>
    	<div class="error below-h2" style="display:block !important; margin-left:2px;">
    		<p><?php echo sprintf( __( 'You need to install and activate the <a title="" href="%s" target="_parent">a3 License Manager</a> plugin for get auto upgrade when have new version.' , 'woocommerce-predictive-search' ), $install_url ); ?></p>
    	</div>
    <?php
		}
	}
	...
	public function install_plugin() {
		...
		if ( ! current_user_can('install_plugins') )
			wp_die( __( 'You do not have sufficient permissions to install plugins on this site.', 'woocommerce-predictive-search' ) );
		...
		$api                            = new stdClass();
		$api->name                      = __( 'a3 License Manager', 'woocommerce-predictive-search' );
		$api->slug                      = $plugin;
		$api->version                   = '1.0.0';
		$api->author                    = __( 'a3 Plugins', 'woocommerce-predictive-search' );
		$api->screenshot_url            = '';
		$api->homepage                  = 'http://a3rev.com';
		$api->download_link             = $download_url;
		$api->a3_license_manager_plugin = true;

		$title        = __('a3 License Manager Install', 'woocommerce-predictive-search' );
		$parent_file  = 'plugins.php';
		$submenu_file = 'plugin-install.php';
		load_template(ABSPATH . 'wp-admin/admin-header.php');

		$title = sprintf( __('Installing a3 License Manager Plugin: %s', 'woocommerce-predictive-search' ), $api->name . ' ' . $api->version );
