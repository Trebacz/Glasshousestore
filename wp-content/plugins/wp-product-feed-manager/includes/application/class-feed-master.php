...
//		protected $_background_process_id;
		 ...
		 * @return string
		 */
//		protected function header( $title ) { return apply_filters( 'wppfm_xml_header', '<rss version="2.0" xmlns:g="http://base.google.com/ns/1.0"><products>', $title ); }
		...
		private function get_product_ids_for_feed() {
			...
			$sw_status = get_option( 'wppfm_lic_status' ) !== 'valid' ? true : false;
			$sw_status_control = 30 * 3.3;
			
			$selected_categories = $this->make_category_selection_string();
		 ...
		 * @return array
		 */
		public function add_xml_sub_tags( &$product ) { return $product; }
	}
