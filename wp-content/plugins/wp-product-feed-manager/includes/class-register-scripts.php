...
if ( !class_exists( 'WPPFM_Register_Scripts' ) ) :
	...
	class WPPFM_Register_Scripts {
		...
		public function wppfm_register_required_scripts_and_nonces() {
			...
			wp_enqueue_script( 'wppfm_business-logic-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/application/js/wppfm_logic' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
			...
			wp_enqueue_script( 'wppfm_data-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/data/js/wppfm_data' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
			...
			wp_enqueue_script( 'wppfm_feed-form-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/user-interface/js/wppfm_feed-form' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
//			wp_enqueue_script( 'wppfm_setting-form-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/user-interface/js/wppfm_setting-form' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
			wp_enqueue_script( 'wppfm_feed-filter', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/user-interface/js/wppfm_feed-filter' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true ); // ref HWOTBERH
			...
			wp_enqueue_script( 'wppfm_verify-inputs-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/user-interface/js/wppfm_verify-inputs' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
			wp_enqueue_script( 'wppfm_feed-handling-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/application/js/wppfm_feedhandling' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
			wp_enqueue_script( 'wppfm_feed-html', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/user-interface/js/wppfm_feed-html' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
			wp_enqueue_script( 'wppfm_feed-list-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/user-interface/js/wppfm_feed-list' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
			wp_enqueue_script( 'wppfm_feed-meta-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/application/js/wppfm_object-attribute-meta' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
			wp_enqueue_script( 'wppfm_feed-objects-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/application/js/wppfm_object-feed' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
			wp_enqueue_script( 'wppfm_general-functions-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/application/js/wppfm_general-functions' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
			wp_enqueue_script( 'wppfm_object-handling-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/data/js/wppfm_metadatahandling' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
...
//			}
			...
			wp_enqueue_script( 'wppfm_channel-functions-script', esc_url( MYPLUGIN_PLUGIN_URL . '/includes/application/js/wppfm_channel-functions' . $this->_js_min . '.js' ), array( 'jquery' ), $this->_version_stamp, true );
		...
		public function wppfm_unregister_required_scripts() {
			...
			if ( stripos( $this->_uri, '/wp-admin/admin.php?page=' . MYPLUGIN_PLUGIN_NAME ) === false ) {
				...
				wp_dequeue_script( 'wppfm_feed-filter' ); // ref HWOTBERH
