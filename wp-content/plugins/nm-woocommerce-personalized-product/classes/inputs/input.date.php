...
class NM_Date_wooproduct extends NM_Inputs_wooproduct{
	...
	*/
	...
	private function get_settings(){
		...
		/*'year_range' => array (
				'type' => 'text',
				'title' => __ ( 'Year Range', 'nm-personalizedproduct' ),
				'desc' => __ ( 'e.g: 1950:2016. Set star/end year like <a target="_blank" href="http://api.jqueryui.com/datepicker/#option-yearRange">Here</a>', 'nm-personalizedproduct' ) 
		),*/
		'logic' => array (
				'type' => 'checkbox',
