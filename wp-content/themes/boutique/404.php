		...
		<main id="main" class="site-main" role="main">
			...
			<div class="error-404 not-found">
				...
				<div class="page-content">
					...
					<p><?php esc_html_e( 'Nothing was found at this location. Try searching, or check out our full online catalog below.', 'storefront' ); ?></p>
...
//						the_widget( 'WC_Widget_Product_Search' );
					// WooCommerce predictive search code to hide native search
						if ( storefront_is_woocommerce_activated() ) {
							if ( function_exists( 'woo_predictive_search_widget' ) ) {  woo_predictive_search_widget( true );
							} else { the_widget( 'WC_Widget_Product_Search', 'title=' ); }
					// End Woocommerce predictive search code
					...
					if ( storefront_is_woocommerce_activated() ) {
						...
						echo '<div class="fourohfour-columns-2">';
							...
							echo '<section class="col-1" aria-label="Promoted Products">';
								...
								storefront_promoted_products(8,2);
